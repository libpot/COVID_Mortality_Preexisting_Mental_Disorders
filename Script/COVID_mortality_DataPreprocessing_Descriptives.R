...
write_csv(number_matched_controls_diag, "C:/Tomas/AZV_project_health_registers_covid_mortality/Results/Tables/number_matched_controls_diag.csv")
write_csv(number_matched_controls_diag_treat, "C:/Tomas/AZV_project_health_registers_covid_mortality/Results/Tables/number_matched_controls_diag_treat.csv")
